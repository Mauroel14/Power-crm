...
for line in list(file_1[0]):
    ...
    try:
        ...
        time.sleep(4)
        lineCompani = browser.find_element(By.XPATH, "//*[@id='root']/div/div[2]/div[2]/div[2]/div[1]/div/div/div[2]/div/div/div[1]/div/div[5]/div/span[2]").text
        print(lineCompani)
        file = open("datosFacturaImpaga.csv","a")
        file1 = file.write("{},{}\n".format(line2,lineCompani))
        file.close()
        time.sleep(4)
        time.sleep(6)
